...
- `ARTICLE_TOPIC` in `data-article-tags` attribute - Main topics if the article. Can include several topics, seperated by ",".This attribute is optional, and is used to support SpotIM's advanced features, such as Topic Pages, Recirculation by Topic, etc.
